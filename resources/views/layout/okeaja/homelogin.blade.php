...
<html lang="en" class="no-js">
	...
	<body>
		...
		<a  class="thumb-nav__item" href="/login"><img src="img/login.png" /></a>
		<a  class="thumb-nav__item" href="/register"><img src="img/register.png" /></a>
			...
			<header class="intro">
				...
				<div class="intro__content">
					...
					<div class="intro__subtitle">
						...
						<button class="trigger" onclick="window.location.href='/login'">
							<svg width="100%" height="100%" viewBox="0 0 60 60" preserveAspectRatio="none">
