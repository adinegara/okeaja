...
<html lang="en" class="no-js">
	<head>
		...
		<title>OkeAja | Platform Referensi Pariwisata</title>
	...
	<body>
		...
		<nav class="thumb-nav">
			<a data-container="container-1" class="thumb-nav__item" href="#"><img src="img/1_thumb.png" alt="thumb01" /><span>1</span></a>
			<a data-container="container-2" class="thumb-nav__item" href="#"><img src="img/2_thumb.png" alt="thumb02" /><span>2</span></a>
			<a data-container="container-3" class="thumb-nav__item" href="#"><img src="img/3_thumb.png" alt="thumb03" /><span>3</span></a>
			<a data-container="container-4" class="thumb-nav__item" href="#"><img src="img/4_thumb.png" alt="thumb04" /><span>4</span></a>

		</nav>	
		<nav class="thumb-nav col-md-3 offset-md-9">
		<a  class="thumb-nav__item" href="/about"><img src="img/about.png" /></a>
		<a  class="thumb-nav__item" href="/submit/create"><img src="img/submit.png" /></a>
		<a  class="thumb-nav__item" href="/logout"><img src="img/logout.png" /></a>
		</nav>

		<div id="container-1" class="container theme-1">
			<header class="intro">
				<img class="intro__image" src="img/1_home.png" alt="OkeAja"/>
				<div class="intro__content">
					<h1 class="intro__title"><a href="/admin">OkeAja</a></h1>
		...
		<div id="container-2" class="container theme-2">
			<header class="intro">
				<img class="intro__image" src="img/2_home.png" alt="Kategori"/>
				<div class="intro__content">
					...
					<div class="intro__subtitle">
						...
						<button class="trigger" onclick="window.location.href='/kategoris'">
							<svg width="100%" height="100%" viewBox="0 0 60 60" preserveAspectRatio="none">
		...
		<div id="container-3" class="container">
			<header class="intro">
				<img class="intro__image" src="img/3_home.png" alt="Lokasi"/>
				<div class="intro__content">
					...
					<div class="intro__subtitle">
						...
						<button class="trigger" onclick="window.location.href='/lokasi'">
							<svg width="100%" height="100%" viewBox="0 0 60 60" preserveAspectRatio="none">
								<use class="icon icon--grid" xlink:href="#icon-grid" />
								<use class="icon icon--cross" xlink:href="#icon-cross" />
							</svg>
		...
		<div id="container-4" class="container">
			<header class="intro">
				<img class="intro__image" src="img/4_home.png" alt="Trending"/>
				<div class="intro__content">
					...
					<div class="intro__subtitle">
						...
						<button class="trigger" onclick="window.location.href='/trending'">
							<svg width="100%" height="100%" viewBox="0 0 60 60" preserveAspectRatio="none">
								<use class="icon icon--grid" xlink:href="#icon-grid" />
								<use class="icon icon--cross" xlink:href="#icon-cross" />
							</svg>
